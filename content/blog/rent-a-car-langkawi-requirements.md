...
metaDescription: >-
  Age 23–65, valid licence, ID, and credit card deposit. How Singapore, India,
  UK/EU, and Australian visitors should prepare for Langkawi pickup.
category: Guides
tag: Requirements
language: en
...
keywords:
  - rent a car langkawi
  - langkawi car rental requirements
...
| Origin                  | Practical preparation                                                                                                                                                 |
| ----------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Malaysia                | Valid Malaysian licence + MyKad                                                                                                                                       |
| Singapore / Brunei      | Home licence commonly accepted for short stays; bring the physical card. Softcopy acceptance at the counter needs confirmation — when unsure, carry an IDP            |
| India                   | Home licence plus an International Driving Permit (1949 Geneva) is the safe default; both must match your passport name                                               |
...
Add a second driver at booking for RM20 (flat add-on in current pricing). They must meet the same age and licence rules and present documents at pickup. A child seat is RM30 per booking when available — see [child seat guide](/en/blog/langkawi-car-rental-child-seat).
