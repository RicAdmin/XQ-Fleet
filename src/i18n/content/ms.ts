...
export const msLandingContent: LandingContent = {
  ...
  blogTips: [
    ...
    },
    {
      ...
      tag: 'Panduan',
      title: 'Cara sewa kereta di Langkawi — dokumen & syarat umur',
      excerpt:
        'Lesen, IDP, deposit, dan semakan umur supaya serah kunci di Door 3 atau jeti tidak tertangguh.',
  ...
  faqs: [
    {
      ...
      a: 'Jika anda berumur antara 23 dan 65 tahun, mempunyai Lesen Memandu Malaysia atau Antarabangsa yang sah, serta mempunyai sekurang-kurangnya satu tahun pengalaman memandu, anda boleh meneruskan penyewaan.',
    },
    {
      c: 'Pickup & Extras',
      q: 'Boleh saya memandu kereta sewa ke mana sahaja dalam pulau ini?',
      a: 'Ya. Kereta sewa membantu anda meneroka Langkawi secara menyeluruh. Menggunakan atau membawa keluar kereta daripada Pulau Langkawi tidak dibenarkan.',
    },
    {
      c: 'Booking & Pricing',
      q: 'Bagaimana kadar penyewaan dikira?',
      a: 'Kadar ditetapkan mengikut blok 24 jam dengan diskaun tambahan untuk tempoh mingguan atau bulanan. Harga berubah mengikut musim dan jenis kenderaan — hubungi khidmat pelanggan untuk sebut harga terkini.',
    },
    {
      c: 'Insurance & Safety',
      q: 'Adakah insurans disertakan?',
      a: 'Skop perlindungan bergantung pada kenderaan dan pilihan tempahan anda. Hubungi kami sebelum bertolak untuk mengesahkan butiran tepat bagi sewaan anda.',
    },
    {
      c: 'Pickup & Extras',
      q: 'Boleh saya mengambil kereta sewa di Lapangan Terbang Antarabangsa Langkawi?',
      a: 'Ya — sewa kereta di lapangan terbang antara perkhidmatan utama kami. Pasukan akan bertemu anda luar Pintu 3 di Dewan Kedatangan Lapangan Terbang Antarabangsa Langkawi (LGK), tersedia 24 jam tanpa caj tambahan. Berikan nombor penerbangan semasa membuat pesanan serta kami mengurus urusan selebihnya.',
    },
    {
      c: 'Insurance & Safety',
      q: 'Bagaimana jika kenderaan rosak?',
      a: 'Hubungi talian khidmat 24 jam pada +60 11 3521 5576 — kami pandu anda melalui langkah seterusnya.',
    },
    {
      c: 'Eligibility',
      q: 'Boleh saya menambah pemandu tambahan?',
      a: 'Sudah tentu — beritahu kepada kami. Caj kecil dikenakan serta pemandu tambahan mestilah memenuhi syarat umur dan lesen sama seperti pemandu utama.',
    },
    {
      c: 'Booking & Pricing',
      q: 'Boleh saya menyewa beberapa jam sahaja?',
      a: 'Minimum sewaan ialah satu hari namun kongsi keperluan khas — pasukan akan cuba memenuhi permohonan anda.',
    },
    {
      c: 'Booking & Pricing',
      q: 'Bagaimana saya boleh menukar atau membatalkan tempahan?',
      a: 'Hubungi pasukan sokongan kami. Pembatalan lebih 48 jam sebelum masa pengambilan adalah percuma; pembatalan lewat kemudian mungkin dikenakan yuran nominal.',
    },
    {
      c: 'Pickup & Extras',
      q: 'Adakah Pulau Langkawi mesra keluarga? Adakah kerusi kanak-kanak disediakan?',
      a: 'Sudah tentu — Pulau Langkawi mesra keluarga dan kami menyediakan kerusi kanak-kanak mengikut permintaan dengan yuran harian berskala kecil.',
    },
    {
      c: 'Insurance & Safety',
      q: 'Bagaimana jika saya lewat mengembalikan kereta sewa?',
      a: 'Jika anda lewat melebihi 30 minit, kos lewat mungkin dikenakan. Maklumkan awal serta kami akan mencari penyelesaian bersama.',
    },
    {
      c: 'Eligibility',
      q: 'Dokumen apa perlu dibawa?',
      a: 'Lesen memandu, pasport, dan kad debit/kredit untuk deposit keselamatan — sekian sahaja.',
    },
    {
      c: 'Booking & Pricing',
      q: 'Boleh menyewakan kereta sepanjang tempoh penginapan?',
      a: 'Sudah tentu — kami menawarkan harga mingguan serta bulanan supaya anda meneroka pulau secara fleksibel.',
    },
    {
      c: 'Booking & Pricing',
      q: 'Apakah pilihan penyewaan kereta paling jimat di Langkawi?',
      a: 'Kereta ekonomi bermula daripada RM 70 sehari serta inilah cara paling jimat untuk memandu sendiri dengan bebas. Tempahkan awal atau inap lebih tujuh malam untuk diskaun lanjut yang digunakan secara automatik semasa pembayaran.',
    },
  ],
  faqCats: [
  ...
  categories: [
    {
      ...
      body: 'Kenderaan kecil sesuai solo, pasangan, dan perjalanan ringkas. Mudah dipark, jimat bahan api, serta lancar melepasi trafik di Pantai Cenang dan bandar utama.',
      fleetKeys: ['economy'],
    ...
    },
    {
      ...
      body: 'Kabin sejuk serta ruang meregang untuk semua, sesuai hari tepi pantai, pemanduan indah, dan percutian keluarga — MPV serta sedan luas menjamin keselesaan terbaik.',
    ...
    },
    {
      ...
      body: 'SUV serta kenderaan serbaguna untuk cerun, titik pandang, dan hari beraktiviti tinggi — ruang simpanan luas untuk peralatan serta keperluan pengembaraan.',
      fleetKeys: ['suv', 'other'],
  ...
  steps: [
    {
      n: '01',
      t: 'Pilih kereta anda',
      d: 'Tapis kapasiti penumpang, gaya pemanduan, atau kemudahan khas — bermula sedan kecil serta MPV sehingga SUV.',
    },
    {
      n: '02',
      t: 'Tempah dalam talian',
      d: 'Masuk maklumat, pilih tarikh, dan selesaikan bayaran selamat. Pengesahan serta-merta dihantar ke peti mel anda.',
    },
    {
      n: '03',
      t: 'Ambil kereta sewa',
      d: 'Kami berjumpa dengan anda di luar kawasan ketibaan lapangan terbang, Jetty Kuah, atau hotel untuk serahan pantas, semakan kenderaan, dan penukaran kunci.',
    },
    {
      n: '04',
      t: 'Nikmati memandu',
      d: 'Teroka Langkawi mengikut masa sendiri. Pasukan tempatan boleh dihubungi melalui WhatsApp untuk panduan serta bantuan tepi jalan.',
    },
    {
      n: '05',
      t: 'Kembalikan kereta',
      d: 'Serahkan kenderaan di lokasi yang dipersetuju. Kami lakukan pemeriksaan serta-merta serta sewaan dianggap selesai.',
    },
  ],
  whyMain: {
    big: '11 tahun',
    bigSub: 'di jalan raya utama Langkawi',
    body: 'XQ Holidays bermula dengan gagasan mudah — iaitu berkongsi yang terbaik daripada Pulau Langkawi bersama dunia. Bermula seawal tahun 2015 armada milik kami diselenggara dengan teliti serta membantu pengunjung meneroka pulau secara selamat serta bebas.',
    bullets: [
  ...
  whyPerks: [
    {
      ...
      d: 'Harga jelas serta memenuhi bajet apa pun serta menarik apabila memilih tempahan mingguan atau bulanan.',
      stat: '0',
      statLabel: 'yuran rahsia',
    },
    {
      t: 'Tempahan mudah',
      d: 'Tempahkan dalam talian serta hantaran percuma ke lapangan terbang, Jetty Kuah, atau hotel pilihan anda.',
      stat: '<2 min',
      statLabel: 'balasan WhatsApp',
    },
    {
      t: 'Memandu dengan keyakinan',
      d: 'Pasukan setempatan tersedia dalam WhatsApp untuk bantuan ambilan serta tips pulau.',
      stat: '24/7',
      statLabel: 'talian WhatsApp',
    },
    {
      t: 'Kereta bagi setiap pengembaraan',
      d: 'Daripada sedan bandar kepada MPV keluarga — semua kenderaan disediakan serta dibersih serta disemak bagi setiap penyewaan.',
      stat: 'Armada',
