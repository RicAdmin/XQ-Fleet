...
import { Banknote, Globe, Image as ImageIcon, LayoutGrid, Layers } from 'lucide-react'
...
const MODEL_TABS = [
  ...
  { value: 'capacity', label: 'Capacity', icon: Layers },
          ...
          <Card size="sm">
            ...
            <CardContent className="pt-3 space-y-2 text-sm">
              ...
              <p className="text-xs text-[var(--sea-ink-soft)]">
                Capacity, website, and pricing for this model are managed in the tabs above.
              </p>
            </CardContent>
          </Card>
