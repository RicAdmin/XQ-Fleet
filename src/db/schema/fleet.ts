...
export const cars = pgTable(
  'cars',
  {
    ...
    notes: text('notes'),
    // Catalog / marketing fields (sourced from data/Car.csv)
    slug: text('slug'),
    ...
    passengers: integer('passengers').notNull().default(5),
    doors: integer('doors').notNull().default(4),
    transmission: text('transmission'),
    fuelType: text('fuel_type'),
    appleCarPlay: boolean('apple_car_play').notNull().default(false),
    androidAuto: boolean('android_auto').notNull().default(false),
    bootCapacityL: integer('boot_capacity_l'),
    bootCapacityLabel: text('boot_capacity_label'),
    largeSuitcasesCount: integer('large_suitcases_count'),
    smallCarryonsCount: integer('small_carryons_count'),
    combinedCapacityL: integer('combined_capacity_l'),
    combinedCapacityLabel: text('combined_capacity_label'),
    tagFunAdventure: boolean('tag_fun_adventure').notNull().default(false),
    tagFamilyComfort: boolean('tag_family_comfort').notNull().default(false),
    tagSmallOku: boolean('tag_small_oku').notNull().default(false),
    ...
    carLocations: text('car_locations'),
  ...
  (table) => [
    ...
    uniqueIndex('cars_slug_unique').on(table.slug),
