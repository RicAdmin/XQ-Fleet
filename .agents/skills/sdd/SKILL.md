...
Use [the shared work-package contract](references/work-package-contract.md) as the authority for archetypes, dependencies, readiness, labels, and controllable completion.
